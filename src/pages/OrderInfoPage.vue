      ...
      <form class="cart__form form" action="#" method="POST">
        <div class="cart__field">
          ...
          <ul class="dictionary">
            ...
            <li class="dictionary__item" v-if="info.comment">
              <span class="dictionary__key">
        ...
        <div class="cart__block">
          ...
          <div class="cart__total">
            ...
            <p>Итого: <b>{{ totalProducts }}</b> {{ totalProductsStr }} на сумму <b>{{ info.totalPrice | numberFormat }} ₽</b></p>
          </div>
        </div>
      </form>
    </section>
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      totalProductsStr: 'orderTotalProductsStr',
    }),
  },
}
</script>
